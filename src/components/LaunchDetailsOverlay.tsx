  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center">
        ...
        <div className="flex justify-center px-6 py-4">
            <div className="h-[50vh] max-w-4xl aspect-video max-h-[50vh]">
