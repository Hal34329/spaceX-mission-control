...
const LaunchDetailsOverlay = ({ launch, onClose }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center">
        ...
        {/* <div className="px-6 pb-6 text-sm text-neutral-300 max-h-[30%] overflow-y-auto">
        ...
        {/* <div className="shrink-0 max-h-[30%] px-6 pb-6 flex flex-col">
        ...
        <div className="relative overflow-y-auto max-h-full bg-surface-darker/40 p-4 rounded-lg group">            
            ...
            {/* <div className="mt-4 grid grid-cols-2 gap-2">
                <div className="text-xs text-neutral-500 uppercase">Success: {launch.success ? "Yes" : "No"}</div>
            </div> */}
            </div>
