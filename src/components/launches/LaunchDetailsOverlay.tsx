                    ...
                    <article className="shrink-0 max-h-[30%] px-6 pb-6 mt-auto">
                        <div className="relative overflow-y-auto max-h-full bg-surface-lighter dark:bg-surface-darker/40 p-4 rounded-lg group">            
                            ...
                            <div className="sticky bottom-0 right-0 flex justify-end mt-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-primary-light/80 dark:text-primary-dark"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6" /><path d="M11 13l9 -9" /><path d="M15 4h5v5" /></svg>
                                </a>
                            </div>
                            )}
                        </div>
