...
const LaunchCard = ({ launch }: LaunchCardProps) => {
  return ( 
    <div className="w-full sm:w-72 mx-auto bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden flex flex-col hover:shadow-2xl">
        ...
        <div className="p-4 flex flex-col grow bg-linear-to-tr from-slate-700 to-slate-500">
            ...
            {launch.details ? (<p className="mt-2 font-sans text-gray-200 grow">
                {launch.details}
