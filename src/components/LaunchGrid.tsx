...
const LaunchGrid = ({ launches }: LaunchGridProps) => {
    return(
        ...
        <div className="flex items-center gap-4 flex-col lg:flex-row">
            <form role="search" id="jobs-search-form" className="min-w-full lg:min-w-md max-w-dvw flex p-2.5 rounded-2xl bg-surface-dark mt-6 lg:my-5 shrink justify-self-center"> 
