...
const LaunchGrid = ({ launches }: LaunchGridProps) => {
    return(
        <>
        <h1 className="text-4xl font-bold">Launch Manifest</h1>
        <h3 className="text-gray-400">Tracking upcoming and past missions.</h3>
        <div className="flex items-center gap-4 flex-col lg:flex-row">
            <form role="search" id="jobs-search-form" className="min-w-full lg:min-w-md max-w-dvw flex p-2.5 rounded-2xl bg-cyan-900 mt-6 lg:my-5 shrink justify-self-center"> 
            ...
            <button className="btn-filter">All missions</button>
